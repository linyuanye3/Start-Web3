...
**铭文（Inscription）**: 主要是比特币生态中的 Oridinals 铭文。它是一种将文本、图片、音频、视频等数据直接嵌入比特币区块链的方式，使得可以永久存储、不可篡改。
...
*DeSci*，(Decetralized Science)去中心化科学，是一种通过区块链等去中心化技术，促进科学研究过程、成果、资金和资源开放和透明化的理念与实践。
