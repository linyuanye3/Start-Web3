...
#### 何謂 Layer 1?
Layer 1 是指區塊鏈網絡的基礎層，包括其核心架構、共識機制和基礎協議。它作為整個區塊鏈生態系統的基石，支撐著所有其他層級和應用程式的運行。
可以想像他是所有區塊練應用的基底，也是蓋房子所需要的地基，若沒有它就沒有所謂的應用。
...
#### 基本概念
- 以太坊是全球性計算機網絡，遵循以太坊協議
- 2015年推出，是可編程的區塊鏈平台
- 2022年9月從工作量證明(PoW)轉為權益證明(PoS)，能耗減少99.95%
#### 核心功能
- 提供無需中央權威的金融服務
- 開放互聯網，允許任何人構建應用
- 點對點網絡，直接交互與資產轉移
...
#### 技術特點
- 智能合約：存儲在區塊鏈上的自動執行程序
- 以太幣(ETH)：平台原生加密貨幣，用於支付計算資源
- 以太坊虛擬機(EVM)：執行智能合約的計算環境
#### 與比特幣區別
- 比特幣主要是數字貨幣
