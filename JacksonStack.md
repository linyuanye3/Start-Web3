...
### 2025.03.23
DeSci（Decentralized Science）是一种新兴的科研模式，它借助区块链技术、智能合约以及去中心化自治组织（DAO）等Web3工具，旨在重塑科学研究的协作、出版、资助和创新流程。  
DeSci 依赖三个关键部分：
- 代币发行。DeSci 通过代币发行（比如 MEME 币），为科研项目提供全球化的资金筹集渠道。研究者不再依赖政府拨款或大型基金会资助，而是可以直接向全球投资者发行代币或 NFT，筹集科研经费。
- 数据上链。DeSci 利用区块链将研究数据存储在分布式网络上，确保数据防篡改、可追溯，并可以将研究成果确权，使科研数据和专利的流通与交易更加透明合规。
- DAO 治理。DeSci 项目由 DAO 组织管理，持有代币的投资者与科研人员可以共同决定资金去向、研究方向及资源分配，进而实现社区驱动的治理与决策，不仅提升了决策的透明度，也降低了科研过程中的利益偏向问题。

DeSci的落地项目
- ResearchHub：由Coinbase创始人Brian Armstrong支持的DeSci项目，提供去中心化的出版和评审新路径，并引入奖励机制，研究人员可通过平台提交论文、评论研究成果，并获取原生代币$RSC作为激励。
- BIO Protocol：专注于生物科技和制药领域的“链上科学孵化器”，通过DAO治理和代币激励机制，为科研团队提供资金管理、实验资源整合和研究成果孵化等服务。
- VitaDAO：致力于抗衰老和延长人类寿命的去中心化科研项目，通过DAO治理模式募集和管理研究资金，研究者可向社区申请资助，社区成员通过持有代币$VITA参与决策。

DeSci面临的挑战
- MEME币融资的监管挑战：DeSci项目普遍依赖发行MEME币进行早期融资，但这种融资方式存在监管风险。例如，美国的FIT21法案和欧盟的MiCA法案都对数字资产的发行和营销提出了严格的监管要求。
- DAO治理的法律灰色地带：DeSci 项目广泛采用 DAO（去中心化自治组织）治理模式，以社区驱动的方式管理科研资金和决策流程。DAO作为法律主体的定位尚不明确，在财务管理、税务合规和合同履行等方面存在法律空白。此外，DAO的资金管理模式也容易引发监管审查。
<!-- Content_END -->
