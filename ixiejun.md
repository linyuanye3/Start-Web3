...
### 2025.03.19
AMA ：Ask Me Anything，通常指项目方或交易负责人举办的问答活动。
AMM：自动做市商。
Alpha：早期的、内部的投资建议或情报。通常是关于加密货币和NFT等数字资产的价值；是对投资回报率超过市场或其他基准提供的回报率的简单。
...
冷钱包：冷钱包，一种用于存储加密货币的离线设备。冷钱包可以是硬件设备，也可以包含用户私有密钥的简单纸片。由于冷钱包没有连接到互联网，它们通常是一种更安全的加密货币存储方法。
