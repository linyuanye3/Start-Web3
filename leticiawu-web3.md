...
✔ 数字资产是什么？
- ㄧ種存在於數字形式的資產。如：加密貨幣如比特幣和以太坊，但也包含我們ㄧ般熟悉的電子郵件、照片、音樂、電子書等。


✔ 为什么数字资产如此受欢迎？
- （這裡特指區塊鏈的範疇），在近幾年裡，數字資產價值飆升，吸引了投資者和媒體的關注，以下有三個原因：
  
1. 稀缺性：以比特幣來說，因為其數量是有限的，相較於傳統的貨幣，會隨著時間推移而減少變得越來越稀缺，價值也隨之增加。
2. 去中心化：數至資產不受中央機構或政府管制。
3. 安全性：通過加密技術，提供了安全、透明和不可篡改的交易方式。
